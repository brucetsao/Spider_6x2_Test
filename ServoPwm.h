...
#define PWM_MaxPulseLength  2500
...
class ServoPwm {
    ...
    private:
        ...
        int minPulseWidth[NumberOfServo] = {  500,  500,  500,  500,  500,  500,  500,  500,  500,  500,  500,  500};  // limit of each servo
        int midPulseWidth[NumberOfServo] = { 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500};  // center of each servo
        int maxPulseWidth[NumberOfServo] = { 2500, 2500, 2500, 2500, 2500, 2500, 2500, 2500, 2500, 2500, 2500, 2500};  // limit of each servo
